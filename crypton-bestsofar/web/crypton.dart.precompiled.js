...
["", "crypton.dart", , V, {
  "^": "",
  main: [function() {
    $.taMessage = document.querySelector("#message");
    $.btnDecode = document.querySelector("#btnDecode");
    $.solution = document.querySelector("#solution");
    $.stats = document.querySelector("#stats");
    $.elapsed = document.querySelector("#elapsed");
    W.HttpRequest_getString("usdic.txt", null, null).then$1(V.getDictionary$closure()).catchError$1(V.handleError$closure());
    W.HttpRequest_getString("ngrams2.txt", null, null).then$1(V.getBigrams$closure()).catchError$1(V.handleError$closure());
    W.HttpRequest_getString("ngrams3.txt", null, null).then$1(V.getTrigrams$closure()).catchError$1(V.handleError$closure());
    var t1 = J.get$onClick$x($.btnDecode);
  ...
  handleError: [function(error) {
    P.print(error);
  }, "call$1", "handleError$closure", 2, 0, 2],
  getDictionary: [function(dict) {
    var wordLines, t1;
    H.setRuntimeTypeInfo([], [J.JSString]);
    wordLines = J.trim$0$s(dict).split("\r\n");
    t1 = P.LinkedHashSet_LinkedHashSet(null, null, null, null);
    $.usWords = t1;
    t1.addAll$1(0, wordLines);
  }, "call$1", "getDictionary$closure", 2, 0, 0],
  getBigrams: [function(bigrams) {
    var ngramLines, t1, kv, t2, t3, t4;
    H.setRuntimeTypeInfo([], [J.JSString]);
    ngramLines = J.trim$0$s(bigrams).split("\r\n");
    $.ngrams2 = P.LinkedHashMap_LinkedHashMap(null, null, null, null, null);
    for (t1 = new H.ListIterator(ngramLines, ngramLines.length, 0, null); t1.moveNext$0();) {
      kv = J.split$1$s(t1._current, "\t");
      t2 = $.ngrams2;
      t3 = kv.length;
      if (0 >= t3)
        return H.ioore(kv, 0);
      ...
      if (1 >= t3)
        return H.ioore(kv, 1);
      t2.$indexSet(0, t4, H.Primitives_parseInt(kv[1], null, null));
    }
  }, "call$1", "getBigrams$closure", 2, 0, 0],
  getTrigrams: [function(trigrams) {
    var ngramLines, t1, kv, t2, t3, t4;
    H.setRuntimeTypeInfo([], [J.JSString]);
    ngramLines = J.trim$0$s(trigrams).split("\r\n");
    $.ngrams3 = P.LinkedHashMap_LinkedHashMap(null, null, null, null, null);
    for (t1 = new H.ListIterator(ngramLines, ngramLines.length, 0, null); t1.moveNext$0();) {
      kv = J.split$1$s(t1._current, "\t");
      t2 = $.ngrams3;
      t3 = kv.length;
    ...
    P.print($.ngrams3);
  }, "call$1", "getTrigrams$closure", 2, 0, 0],
  onMessageChanged: function() {
    var t1, t2, justWords, t3, t4, t5;
    $.solved = false;
    $.message = J.get$value$x($.taMessage);
    $.generation = 1;
    $.civilization = 1;
    $.potentials = H.setRuntimeTypeInfo([], [V.Chromosome]);
    t1 = $.message;
    t2 = H.JSSyntaxRegExp_makeNative("[^a-zA-Z| ]", false, true, false);
    justWords = J.replaceAll$2$s(t1, "-", " ");
    t1 = H.stringReplaceAllUnchecked(justWords, new H.JSSyntaxRegExp(t2, null, null), "").toLowerCase();
    $.justWords = t1;
    t1 = t1.split(" ");
    $.wordsInMessage = t1;
    P.print("" + t1.length + " words in meessage =\n " + H.S($.wordsInMessage));
    for (; $.get$potentials().length <= $.genSize;) {
      t1 = $.get$adam();
      t1 = V.shuffle(t1, C.C__JSRandom.nextInt$1(400));
      $.mutant = t1;
      t1 = V.score_nGrams(t1);
      $.theScore = t1;
      t2 = $.get$potentials();
      t3 = $.mutant;
      t4 = new V.Chromosome(null, null);
    ...
    t1 = new P.Stopwatch(1000000, null, null);
    t1.start$0(0);
    $.stopwatch = t1;
    P.Timer_Timer(P.Duration$(0, 0, 0, 500, 0, 0), new V.onMessageChanged_closure());
  },
  nextGeneration: function() {
    var t1, t2, t3, wordPercent, spread, outStats, i, newMutant, t4, t5, duration;
    t1 = $.get$potentials();
    t1.toString;
    if (typeof t1 !== "object" || t1 === null || !!t1.immutable$list)
      H.throwExpression(P.UnsupportedError$("sort"));
    H.Sort__doSort(t1, 0, t1.length - 1, new V.nextGeneration_closure());
    t1 = $.get$potentials();
    t2 = $.genSize / 3 | 0;
    t3 = t1.length;
    t1.toString;
    ...
    if (t3 < t2 || t3 > t3)
      H.throwExpression(P.RangeError$range(t3, t2, t3));
    H.Lists_copy(t1, t3, t1, t2, t3 - t3);
    J.set$length$asx(t1, t3 - (t3 - t2));
    wordPercent = V.score(J.get$first$ax($.get$potentials()).sequence) / $.wordsInMessage.length;
    spread = (J.get$first$ax($.get$potentials()).fitness - J.get$last$ax($.get$potentials()).fitness) / J.get$first$ax($.get$potentials()).fitness;
    outStats = "Civilization " + $.civilization + ", Generation " + $.generation + " scores=" + H.S(J.get$first$ax($.get$potentials()).fitness) + "-" + H.S(J.get$last$ax($.get$potentials()).fitness) + ", diversity=" + C.JSNumber_methods.toStringAsPrecision$1(spread * 100, 4) + "%, words=" + C.JSInt_methods.toStringAsPrecision$1(wordPercent * 100, 4) + "%";
    H.S(V.decode(J.get$first$ax($.get$potentials()).sequence));
    J.set$innerHtml$x($.solution, V.decodeOriginalMessage(J.get$first$ax($.get$potentials()).sequence));
    $.stats.textContent = outStats;
    t1 = $.stopwatch;
    t1 = P.Duration$(0, 0, C.JSNumber_methods.$tdiv(t1.get$elapsedTicks() * 1000000, t1.frequency), 0, 0, 0);
    $.duration = t1;
    $.elapsed.textContent = "Elapsed Time: " + H.S(t1);
    for (i = 0; i < ($.genSize / 3 | 0); ++i) {
      t1 = $.get$potentials();
      if (i >= t1.length)
        return H.ioore(t1, i);
      newMutant = V.shuffle(t1[i].sequence, 1);
      t1 = $.get$potentials();
      t2 = V.score_nGrams(newMutant);
      t3 = new V.Chromosome(null, null);
      t4 = P.LinkedHashMap_LinkedHashMap(null, null, null, null, null);
      t4.addAll$1(0, newMutant);
      t3.sequence = t4;
      t3.fitness = t2;
      t1.push(t3);
    }
    if (J.get$first$ax($.get$potentials()).fitness !== J.get$last$ax($.get$potentials()).fitness)
      t1 = spread < 0.03 && wordPercent < 0.28;
    else
      t1 = true;
    if (t1) {
      J.set$length$asx($.get$potentials(), 0);
      $.civilization = $.civilization + 1;
      $.generation = 1;
    }
    $.mutant = V.shuffle($.get$adam(), 50);
    for (; t1 = $.get$potentials(), t1.length <= $.genSize;) {
      t1 = $.get$adam();
      t1 = V.shuffle(t1, C.C__JSRandom.nextInt$1(3));
      $.mutant = t1;
      t1 = V.score_nGrams(t1);
      $.theScore = t1;
      t2 = $.get$potentials();
    ...
    if (V.score(J.get$first$ax(t1).sequence) === $.wordsInMessage.length)
      $.solved = true;
    else {
    ...
    if ($.solved) {
      t1 = $.stopwatch;
      duration = P.Duration$(0, 0, C.JSNumber_methods.$tdiv(t1.get$elapsedTicks() * 1000000, t1.frequency), 0, 0, 0);
      $.elapsed.textContent = "COMPLETED IN: " + H.S(duration);
      P.print("COMPLETED IN " + H.S(duration));
      P.print("score=" + H.S(V.score_nGrams(J.get$first$ax($.get$potentials()).sequence)) + ", " + $.tries + " tries, Key=" + H.S(J.get$first$ax($.get$potentials()).sequence) + "\n");
      P.print(V.decode(J.get$first$ax($.get$potentials()).sequence));
    } else
      P.Timer_Timer(P.Duration$(0, 0, 0, 2, 0, 0), new V.nextGeneration_closure0());
  },
  score: function(key) {
    var decodedWords, t1, keyScore, word;
    decodedWords = V.decode(key);
    for (t1 = new H.ListIterator(decodedWords, decodedWords.length, 0, null), keyScore = 0; t1.moveNext$0();) {
      word = t1._current;
      if ($.usWords.contains$1(0, word))
        ++keyScore;
    }
    return keyScore;
  },
  score_nGrams: function(key) {
    var decodedWords, t1, keyScore, word, t2, i, t3, twoLetters, threeLetters;
    decodedWords = V.decode(key);
    for (t1 = new H.ListIterator(decodedWords, decodedWords.length, 0, null), keyScore = 0; t1.moveNext$0();) {
      word = t1._current;
      ...
      while (true) {
        ...
        if (!(i < t3 - 1))
          break;
        twoLetters = t2.substring$2(word, i, i + 2);
        if ($.ngrams2.$index(0, twoLetters) != null) {
          t3 = J.$tdiv$n($.ngrams2.$index(0, twoLetters), 2858953);
          if (typeof t3 !== "number")
            return H.iae(t3);
          keyScore += t3;
        }
    ...
    for (t1 = new H.ListIterator(decodedWords, decodedWords.length, 0, null); t1.moveNext$0();) {
      word = t1._current;
      t2 = J.getInterceptor$asx(word);
      i = 0;
      while (true) {
        ...
        if (!(i < t3 - 2))
          break;
        threeLetters = t2.substring$2(word, i, i + 3);
        if ($.ngrams3.$index(0, threeLetters) != null) {
          t3 = J.$tdiv$n($.ngrams3.$index(0, threeLetters), 6254);
          if (typeof t3 !== "number")
            return H.iae(t3);
          keyScore += t3;
        }
  ...
  decode: function(theKey) {
    var decoded, t1, word, t2, thisWord, i, t3;
    decoded = H.setRuntimeTypeInfo([], [J.JSString]);
    for (t1 = $.wordsInMessage, t1 = new H.ListIterator(t1, t1.length, 0, null); t1.moveNext$0();) {
      word = t1._current;
      t2 = J.getInterceptor$asx(word);
      thisWord = "";
      i = 0;
      while (true) {
        ...
        if (!(i < t3))
          break;
        thisWord = C.JSString_methods.$add(thisWord, theKey.$index(0, J.toLowerCase$0$s(t2.$index(word, i))));
        ++i;
      }
      decoded.push(thisWord);
    }
    return decoded;
  },
  shuffle: function(original, entropy) {
    var shuffled, i, t1, charCodes, t2, newChromosome;
    shuffled = P.LinkedHashMap_LinkedHashMap(null, null, null, null, null);
    shuffled.addAll$1(0, original);
    for (i = 0; i < entropy; ++i) {
      t1 = C.C__JSRandom.nextInt$1(26);
      charCodes = P.List_List$filled(1, t1 + "a".charCodeAt(0), J.JSInt);
      t1 = H.Primitives_stringFromCharCodes(charCodes);
      t2 = C.C__JSRandom.nextInt$1(26);
      charCodes = P.List_List$filled(1, t2 + "a".charCodeAt(0), J.JSInt);
      t2 = H.Primitives_stringFromCharCodes(charCodes);
      newChromosome = P.LinkedHashMap_LinkedHashMap(null, null, null, null, null);
      newChromosome.addAll$1(0, shuffled);
      newChromosome.$indexSet(0, t1, shuffled.$index(0, t2));
      newChromosome.$indexSet(0, t2, shuffled.$index(0, t1));
      shuffled = P.LinkedHashMap_LinkedHashMap(null, null, null, null, null);
      shuffled.addAll$1(0, newChromosome);
    }
    return shuffled;
  },
  decodeOriginalMessage: function(key) {
    var decodedText, i, t1, character;
    for (decodedText = "", i = 0; t1 = $.message, i < J.get$length$asx(t1); ++i) {
      if (i < 0 || i >= t1.length)
        return H.ioore(t1, i);
      character = t1[i].toLowerCase();
      decodedText = key.$index(0, character) != null ? decodedText + J.toUpperCase$0$s(key.$index(0, character)) : decodedText + character.toUpperCase();
    }
    $.prevDecodedMessage = decodedText;
    return V.emphasizeWords(decodedText);
  },
  emphasizeWords: function(text) {
    var t1, returnString, nextWord, inWord, i, character, t2;
    for (t1 = text.length, returnString = "", nextWord = "", inWord = false, i = 0; i < t1; ++i) {
      character = text[i].toLowerCase();
      t2 = H.JSSyntaxRegExp_makeNative("[a-z]", false, true, false);
      if (H.stringContainsUnchecked(character, new H.JSSyntaxRegExp(t2, null, null), 0)) {
        nextWord += character;
        inWord = true;
      } else {
        if (nextWord.length > 0) {
          returnString = $.usWords.contains$1(0, nextWord) ? returnString + ("<em>" + nextWord.toUpperCase() + "</em>") : returnString + nextWord.toUpperCase();
          nextWord = "";
          inWord = false;
        }
  ...
  Chromosome: {
    "^": "Object;sequence,fitness<"
  },
  main_closure: {
    "^": "Closure:11;",
    call$1: function(e) {
      P.print("clicked button");
      V.onMessageChanged();
      return;
    }
  },
  onMessageChanged_closure: {
    "^": "Closure:9;",
    call$0: function() {
      return V.nextGeneration();
    }
  },
  nextGeneration_closure: {
    "^": "Closure:10;",
    call$2: function(x, y) {
      return C.JSNumber_methods.compareTo$1(y.get$fitness(), x.get$fitness());
    }
  },
  nextGeneration_closure0: {
    "^": "Closure:9;",
    call$0: function() {
      return V.nextGeneration();
    }
...
["dart.core", "dart:core", , P, {
  ...
  }, "call$2", "Comparable_compare$closure", 4, 0, 5],
...
Isolate.$lazy($, "adam", "adam", "get$adam", function() {
  return H.fillLiteralMap(["a", "a", "b", "b", "c", "c", "d", "d", "e", "e", "f", "f", "g", "g", "h", "h", "i", "i", "j", "j", "k", "k", "l", "l", "m", "m", "n", "n", "o", "o", "p", "p", "q", "q", "r", "r", "s", "s", "t", "t", "u", "u", "v", "v", "w", "w", "x", "x", "y", "y", "z", "z"], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null));
});
Isolate.$lazy($, "potentials", "potentials", "get$potentials", function() {
  return H.setRuntimeTypeInfo([], [V.Chromosome]);
});
...
{func: "void__Error", void: true, args: [P.Error]},
...
;(function (callback) {
  ...
  if (typeof dartMainRunner === "function") {
    dartMainRunner((function(a){H.startRootIsolate(V.main$closure(),a)}), []);
  } else {
    (function(a){H.startRootIsolate(V.main$closure(),a)})([]);
  }
});
// END invoke [main].
function init() {
...
function dart_precompiled($collectedClasses) {
  ...
  function Chromosome(sequence, fitness) {
    this.sequence = sequence;
    this.fitness = fitness;
  }
  Chromosome.builtin$cls = "Chromosome";
  if (!"name" in Chromosome)
    Chromosome.name = "Chromosome";
  $desc = $collectedClasses.Chromosome;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Chromosome.prototype = $desc;
  Chromosome.prototype.get$fitness = function() {
    return this.fitness;
  };
  ...
  function onMessageChanged_closure() {
  }
  onMessageChanged_closure.builtin$cls = "onMessageChanged_closure";
  if (!"name" in onMessageChanged_closure)
    onMessageChanged_closure.name = "onMessageChanged_closure";
  $desc = $collectedClasses.onMessageChanged_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  onMessageChanged_closure.prototype = $desc;
  function nextGeneration_closure() {
  }
  nextGeneration_closure.builtin$cls = "nextGeneration_closure";
  if (!"name" in nextGeneration_closure)
    nextGeneration_closure.name = "nextGeneration_closure";
  $desc = $collectedClasses.nextGeneration_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  nextGeneration_closure.prototype = $desc;
  function nextGeneration_closure0() {
  }
  nextGeneration_closure0.builtin$cls = "nextGeneration_closure0";
  if (!"name" in nextGeneration_closure0)
    nextGeneration_closure0.name = "nextGeneration_closure0";
  $desc = $collectedClasses.nextGeneration_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  nextGeneration_closure0.prototype = $desc;
