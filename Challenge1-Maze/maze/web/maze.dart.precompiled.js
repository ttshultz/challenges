...
Interceptor: {"": "Object;",
  ...
  "%": "CanvasRenderingContext|CanvasRenderingContext2D|DOMError|FileError|MediaError|MediaKeyError|Navigator|NavigatorUserMediaError|PositionError|SQLError|SVGAnimatedLength|SVGAnimatedLengthList|SVGAnimatedNumber|SVGAnimatedNumberList"
},
...
InputElement: {"": "HtmlElement;src},value=", "%": "HTMLInputElement"},
...
["", "maze.dart", , F, {
render: function(m1) {
  var canvas, context, img, t1, t2, t3, box_1, box_10, box_0, box_00, cell, $arguments;
  ...
  t1.set$src(img, "sheet.png");
  t2 = t1.get$onLoad(img);
  t3 = new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new F.render_closure(context, img)), t2._useCapture);
  H.setRuntimeTypeInfo(t3, [H.getRuntimeTypeArgument(t2, "_EventStream", 0)]);
  t3._tryResume$0();
  box_1 = {};
  for (box_1.i_1 = 0; box_1.i_1 < 30; box_10 = {}, box_10.i_1 = box_1.i_1, box_10.i_1 = box_10.i_1 + 1, box_1 = box_10) {
    box_0 = {};
    for (box_0.j_0 = 0; t2 = box_0.j_0, t2 < 30; box_00 = {}, box_00.j_0 = box_0.j_0, box_00.j_0 = box_00.j_0 + 1, box_0 = box_00) {
      cell = m1.value$2(m1, t2, box_1.i_1);
      if (cell === $.WALL) {
        t2 = t1.get$onLoad(img);
        $arguments = H.substitute(t2.$as_EventStream, H.getRuntimeTypeInfo(t2));
        t3 = $arguments == null ? null : $arguments[0];
        t2 = new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new F.render_closure0(box_0, box_1, context, img, 16)), t2._useCapture);
        ...
        $arguments = H.substitute(t2.$as_EventStream, H.getRuntimeTypeInfo(t2));
        t3 = $arguments == null ? null : $arguments[0];
        t2 = new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new F.render_closure1(box_0, box_1, context, img, 16)), t2._useCapture);
        t2.$builtinTypeInfo = [t3];
        t3 = t2._onData;
        if (t3 != null && t2._pauseCount <= 0)
          J.addEventListener$3$x(t2._target, t2._eventType, t3, t2._useCapture);
        ...
        $arguments = H.substitute(t2.$as_EventStream, H.getRuntimeTypeInfo(t2));
        t3 = $arguments == null ? null : $arguments[0];
        t2 = new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new F.render_closure2(box_0, box_1, context, img, 16)), t2._useCapture);
        t2.$builtinTypeInfo = [t3];
        t3 = t2._onData;
        if (t3 != null && t2._pauseCount <= 0)
          J.addEventListener$3$x(t2._target, t2._eventType, t3, t2._useCapture);
        ...
        $arguments = H.substitute(t2.$as_EventStream, H.getRuntimeTypeInfo(t2));
        t3 = $arguments == null ? null : $arguments[0];
        t2 = new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new F.render_closure3(box_0, box_1, context, img, 16)), t2._useCapture);
        t2.$builtinTypeInfo = [t3];
        t3 = t2._onData;
        if (t3 != null && t2._pauseCount <= 0)
          J.addEventListener$3$x(t2._target, t2._eventType, t3, t2._useCapture);
        ...
        $arguments = H.substitute(t2.$as_EventStream, H.getRuntimeTypeInfo(t2));
        t3 = $arguments == null ? null : $arguments[0];
        t2 = new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new F.render_closure4(box_0, box_1, context, img, 16)), t2._useCapture);
        t2.$builtinTypeInfo = [t3];
        t3 = t2._onData;
        if (t3 != null && t2._pauseCount <= 0)
          J.addEventListener$3$x(t2._target, t2._eventType, t3, t2._useCapture);
...
onMazeChanged: function() {
  $.inputText = null;
  var t1 = P.List_List(null, J.JSString);
  H.setRuntimeTypeInfo(t1, [J.JSString]);
  $.inputText = t1;
  J.addAll$1$ax($.inputText, J.split$1$s(J.get$value$x($.taMaze), "\n"));
},

onSolveClicked: function() {
  F.onMazeChanged();
  $.theMaze = null;
  H.IterableMixinWorkaround_removeWhereList($.get$queue(), new F.onSolveClicked_closure());
  $.theMaze = F.Maze$($.inputText);
  $.theMaze.solve$0();
  F.render($.theMaze);
},
...
main: function() {
  var t1, t2;
  $.taMaze = document.querySelector("#taMaze");
  $.btnSolve = document.querySelector("#btnSolve");
  t1 = $.btnSolve;
  t1.toString;
...
Node: {"": "Object;x,y,parent"},

Maze: {"": "Object;contents,start,end,visited",
  findSymbol$1: function(symbol) {
    var y, x;
    for (y = 0; y < 30; ++y)
      for (x = 0; x < 30; ++x)
        if (this.value$2(this, x, y) === symbol)
          return new F.Node(x, y, null);
    return;
  },
  value$2: function(_, x, y) {
    var t1, t2;
    if (x > 29 || y > 29)
      return $.WALL;
    t1 = x + 1;
    ...
    if (t1 > 29) {
      if (y < 0 || y >= t2.length)
        throw H.ioore(t2, y);
      return J.substring$1$s(t2[y], x);
    } else {
      if (y < 0 || y >= t2.length)
        throw H.ioore(t2, y);
      return J.substring$2$s(t2[y], x, t1);
    }
  },
  isPath$3: function(x, y, current) {
    var result, t1;
    result = !(x < 0 || x > 29 || y < 0 || y > 29) || false;
    if (this.value$2(this, x, y) === $.WALL)
      result = false;
    t1 = this.visited;
    return t1.contains$1(t1, C.JSInt_methods.toString$0(x) + "," + C.JSInt_methods.toString$0(y)) ? false : result;
  },
  solve$0: function() {
    var t1, current, t2, t3, visit, t4;
    $.get$queue().push(this.start);
    t1 = $.get$queue();
    if (0 >= t1.length)
      throw H.ioore(t1, 0);
    current = t1[0];
    while (true) {
      t1 = current.x;
      t2 = current.y;
      if (this.value$2(this, t1, t2) === $.END)
        t3 = !(t1 < 0 || t1 > 29 || t2 < 0 || t2 > 29);
      else
        t3 = false;
      if (!!(t3 && true))
        break;
      visit = C.JSInt_methods.toString$0(t1) + "," + C.JSInt_methods.toString$0(t2);
      t3 = this.visited;
      t3.add$1(t3, visit);
      t3 = t1 - 1;
      if (this.isPath$3(t3, t2, current))
        $.get$queue().push(new F.Node(t3, t2, current));
      t3 = t1 + 1;
      if (this.isPath$3(t3, t2, current))
        $.get$queue().push(new F.Node(t3, t2, current));
      t3 = t2 - 1;
      if (this.isPath$3(t1, t3, current))
        $.get$queue().push(new F.Node(t1, t3, current));
      ++t2;
      if (this.isPath$3(t1, t2, current))
        $.get$queue().push(new F.Node(t1, t2, current));
      C.JSArray_methods.removeAt$1($.get$queue(), 0);
      t1 = $.get$queue();
      if (0 >= t1.length)
        throw H.ioore(t1, 0);
      current = t1[0];
    }
    for (t1 = this.contents; current = current.parent, t2 = current != null, t2;)
      if (t2 && this.value$2(this, current.x, current.y) !== $.START) {
        t2 = current.x;
        t3 = current.y;
        t4 = $.TRAIL;
        if (t3 < 0 || t3 >= t1.length)
          throw H.ioore(t1, t3);
        t4 = J.substring$2$s(t1[t3], 0, t2) + t4;
        if (t3 >= t1.length)
          throw H.ioore(t1, t3);
        t2 = t4 + J.substring$1$s(t1[t3], t2 + 1);
        if (t3 >= t1.length)
          throw H.ioore(t1, t3);
        t1[t3] = t2;
      }
  },
  Maze$1: function(contents) {
    this.start = this.findSymbol$1($.START);
    this.end = this.findSymbol$1($.END);
    this.visited = P.LinkedHashSet_LinkedHashSet(null, null, null, null);
  },
  static: {
Maze$: function(contents) {
  var t1 = new F.Maze(contents, null, null, null);
  t1.Maze$1(contents);
  return t1;
}}
...
render_closure: {"": "Closure;context_2,img_3",
  call$1: function(value) {
    return this.context_2.drawImage(this.img_3, 0, 0, 8, 9, 0, 0, 16, 16);
  },
  $is_args1: true
},

render_closure0: {"": "Closure;box_0,box_1,context_4,img_5,size_6",
  call$1: function(value) {
    var t1 = this.size_6;
    return this.context_4.drawImage(this.img_5, 0, 0, 8, 8, this.box_0.j_0 * t1, this.box_1.i_1 * t1, t1, t1);
  },
  $is_args1: true
},

render_closure1: {"": "Closure;box_0,box_1,context_7,img_8,size_9",
  call$1: function(value) {
    var t1 = this.size_9;
    return this.context_7.drawImage(this.img_8, 8, 0, 8, 8, this.box_0.j_0 * t1, this.box_1.i_1 * t1, t1, t1);
  },
  $is_args1: true
},

render_closure2: {"": "Closure;box_0,box_1,context_10,img_11,size_12",
  call$1: function(value) {
    var t1 = this.size_12;
    return this.context_10.drawImage(this.img_11, 16, 0, 8, 8, this.box_0.j_0 * t1, this.box_1.i_1 * t1, t1, t1);
  },
  $is_args1: true
},

render_closure3: {"": "Closure;box_0,box_1,context_13,img_14,size_15",
  call$1: function(value) {
    var t1 = this.size_15;
    return this.context_13.drawImage(this.img_14, 24, 0, 8, 8, this.box_0.j_0 * t1, this.box_1.i_1 * t1, t1, t1);
  },
  $is_args1: true
},

render_closure4: {"": "Closure;box_0,box_1,context_16,img_17,size_18",
  call$1: function(value) {
    var t1 = this.size_18;
    return this.context_16.drawImage(this.img_17, 32, 0, 8, 8, this.box_0.j_0 * t1, this.box_1.i_1 * t1, t1, t1);
  },
  $is_args1: true
},

onSolveClicked_closure: {"": "Closure;",
  call$1: function(e) {
    return true;
  },
  $is_args1: true
...
function dart_precompiled($collectedClasses) {
  ...
  if ($desc instanceof Array)
    $desc = $desc[1];
  Node.prototype = $desc;
  function Maze(contents, start, end, visited) {
  ...
  if ($desc instanceof Array)
    $desc = $desc[1];
  Maze.prototype = $desc;
  function render_closure(context_2, img_3) {
    this.context_2 = context_2;
    this.img_3 = img_3;
  }
  render_closure.builtin$cls = "render_closure";
  if (!"name" in render_closure)
    render_closure.name = "render_closure";
  $desc = $collectedClasses.render_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  render_closure.prototype = $desc;
  function render_closure0(box_0, box_1, context_4, img_5, size_6) {
    this.box_0 = box_0;
    this.box_1 = box_1;
  ...
  render_closure0.builtin$cls = "render_closure0";
  if (!"name" in render_closure0)
    render_closure0.name = "render_closure0";
  $desc = $collectedClasses.render_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  render_closure0.prototype = $desc;
  function render_closure1(box_0, box_1, context_7, img_8, size_9) {
    this.box_0 = box_0;
    this.box_1 = box_1;
  ...
  render_closure1.builtin$cls = "render_closure1";
  if (!"name" in render_closure1)
    render_closure1.name = "render_closure1";
  $desc = $collectedClasses.render_closure1;
  if ($desc instanceof Array)
    $desc = $desc[1];
  render_closure1.prototype = $desc;
  function render_closure2(box_0, box_1, context_10, img_11, size_12) {
    this.box_0 = box_0;
    this.box_1 = box_1;
    this.context_10 = context_10;
    this.img_11 = img_11;
    this.size_12 = size_12;
  }
  render_closure2.builtin$cls = "render_closure2";
  if (!"name" in render_closure2)
    render_closure2.name = "render_closure2";
  $desc = $collectedClasses.render_closure2;
  if ($desc instanceof Array)
    $desc = $desc[1];
  render_closure2.prototype = $desc;
  function render_closure3(box_0, box_1, context_13, img_14, size_15) {
    this.box_0 = box_0;
    this.box_1 = box_1;
    this.context_13 = context_13;
    this.img_14 = img_14;
    this.size_15 = size_15;
  }
  render_closure3.builtin$cls = "render_closure3";
  if (!"name" in render_closure3)
    render_closure3.name = "render_closure3";
  $desc = $collectedClasses.render_closure3;
  if ($desc instanceof Array)
    $desc = $desc[1];
  render_closure3.prototype = $desc;
  function render_closure4(box_0, box_1, context_16, img_17, size_18) {
    this.box_0 = box_0;
    this.box_1 = box_1;
    this.context_16 = context_16;
    this.img_17 = img_17;
    this.size_18 = size_18;
  }
  render_closure4.builtin$cls = "render_closure4";
  if (!"name" in render_closure4)
    render_closure4.name = "render_closure4";
  $desc = $collectedClasses.render_closure4;
  if ($desc instanceof Array)
    $desc = $desc[1];
  render_closure4.prototype = $desc;
  function onSolveClicked_closure() {
  }
  onSolveClicked_closure.builtin$cls = "onSolveClicked_closure";
  if (!"name" in onSolveClicked_closure)
    onSolveClicked_closure.name = "onSolveClicked_closure";
  $desc = $collectedClasses.onSolveClicked_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  onSolveClicked_closure.prototype = $desc;
