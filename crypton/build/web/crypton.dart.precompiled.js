...
["", "crypton.dart", , V, {
  ...
  main: [function() {
    ...
    $.keyOut = document.querySelector("#keyOut");
  ...
  onMessageChanged: function() {
    ...
    t1 = H.stringReplaceAllUnchecked(justWords, new H.JSSyntaxRegExp("[^a-zA-Z| ]", t2, null, null), "").toLowerCase();
    $.justWords = t1;
    $.wordsInMessage = t1.split(" ");
  ...
  nextGeneration: function() {
    var t1, t2, t3, wordPercent, spread, outStats, decodedMsg, t4, t5, i, newMutant, duration;
    t1 = $.get$potentials();
    t1.toString;
    ...
    wordPercent = V.score(J.get$first$ax($.get$potentials()).get$sequence()) / $.wordsInMessage.length;
    spread = (J.get$first$ax($.get$potentials()).get$fitness() - J.get$last$ax($.get$potentials()).get$fitness()) / J.get$first$ax($.get$potentials()).get$fitness();
    outStats = "Civilization " + $.civilization + ", Generation " + $.generation + " scores=" + J.get$first$ax($.get$potentials()).get$fitness() + "-" + J.get$last$ax($.get$potentials()).get$fitness() + ", diversity=" + C.JSInt_methods.toStringAsPrecision$1(spread * 100, 4) + "%, words=" + C.JSInt_methods.toStringAsPrecision$1(wordPercent * 100, 4) + "%";
    J.set$innerHtml$x($.keyOut, P.Maps_mapToString(J.get$first$ax($.get$potentials()).get$sequence()));
    H.S(V.decode(J.get$first$ax($.get$potentials()).get$sequence()));
    decodedMsg = V.decodeOriginalMessage(J.get$first$ax($.get$potentials()).get$sequence());
    J.set$innerHtml$x($.solution, V.emphasizeWords(decodedMsg));
    $.stats.textContent = outStats;
    t1 = $.stopwatch;
    t1 = P.Duration$(0, 0, C.JSNumber_methods.$tdiv(t1.get$elapsedTicks() * 1000000, t1.frequency), 0, 0, 0);
    $.duration = t1;
    $.elapsed.textContent = "Elapsed Time: " + t1.toString$0(0);
    if (J.get$first$ax($.get$potentials()).get$fitness() !== J.get$last$ax($.get$potentials()).get$fitness())
      t1 = spread < 0.0001 && wordPercent < 0.28;
    else
      t1 = true;
    if (t1) {
      ...
      for (; $.get$potentials().length <= $.genSize;) {
        t1 = $.get$adam();
        t1 = V.shuffle(t1, C.C__JSRandom.nextInt$1(3) + 1);
        $.mutant = t1;
        t1 = V.score_nGrams(t1);
        $.theScore = t1;
        t2 = $.get$potentials();
    ...
    for (i = 0; t1 = $.get$potentials(), t2 = t1.length, t2 <= $.genSize;) {
      if (i >= t2)
        return H.ioore(t1, i);
      t1 = t1[i].get$sequence();
      newMutant = V.shuffle(t1, C.C__JSRandom.nextInt$1(3) + 1);
      t1 = $.get$potentials();
    ...
    if ($.solved) {
      ...
      $.elapsed.textContent = "COMPLETED IN: " + duration.toString$0(0);
      J.set$innerHtml$x($.solution, "<em>" + decodedMsg + "</em>");
    } else
      P.Timer_Timer(P.Duration$(0, 0, 0, 3, 0, 0), new V.nextGeneration_closure0());
  },
  score: function(key) {
  ...
  score_nGrams: function(key) {
    var decodedWords, t1, keyScore, word, t2, i, t3, threeLetters;
    decodedWords = V.decode(key);
    for (t1 = new H.ListIterator(decodedWords, decodedWords.length, 0, null), keyScore = 0; t1.moveNext$0();) {
      word = t1._current;
      ...
      while (true) {
        ...
        if ($.ngrams3.$index(0, threeLetters) != null)
          keyScore += V.log2($.ngrams3.$index(0, threeLetters));
        ++i;
      }
    }
    return keyScore;
  ...
  log2: function(n) {
    var bits;
    for (bits = 0; J.getInterceptor$n(n).$gt(n, 0);) {
      ++bits;
      if (typeof n !== "number")
        return n.$shr();
      n = C.JSNumber_methods._shrOtherPositive$1(n, 1);
    }
    return bits;
  },
  decode: function(theKey) {
    var decoded, t1, word, t2, thisWord, i, t3;
    decoded = H.setRuntimeTypeInfo([], [P.String]);
  ...
  decodeOriginalMessage: function(key) {
    var decodedText, i, character;
    for (decodedText = "", i = 0; i < J.get$length$asx($.message); ++i) {
      character = J.$index$asx($.message, i).toLowerCase();
  ...
  emphasizeWords: function(text) {
    ...
    for (t1 = text.length, returnString = "", nextWord = "", inWord = false, i = 0; i < t1; ++i) {
      ...
      if (H.stringContainsUnchecked(character, new H.JSSyntaxRegExp("[a-z]", t2, null, null), 0)) {
        nextWord += character;
        inWord = true;
      } else {
    ...
    return nextWord.length > 0 ? returnString + nextWord.toUpperCase() : returnString;
  },
  Chromosome: {
  ...
  nextGeneration_closure: {
    "^": "Closure:15;",
    call$2: function(x, y) {
      return C.JSInt_methods.compareTo$1(y.get$fitness(), x.get$fitness());
    }
  },
...
Isolate.$lazy($, "adam", "adam", "get$adam", function() {
  return P.LinkedHashMap_LinkedHashMap$_literal(["a", "a", "b", "b", "c", "c", "d", "d", "e", "e", "f", "f", "g", "g", "h", "h", "i", "i", "j", "j", "k", "k", "l", "l", "m", "m", "n", "n", "o", "o", "p", "p", "q", "q", "r", "r", "s", "s", "t", "t", "u", "u", "v", "v", "w", "w", "x", "x", "y", "y", "z", "z"], null, null);
});
...
function dart_precompiled($collectedClasses) {
  ...
  Chromosome.prototype.get$sequence = function() {
